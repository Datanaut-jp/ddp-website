  ...
  return (
    <section className="bg-gradient-to-r from-blue-300 via-cyan-200 to-blue-300 py-16 sm:py-24">
      <div className="container mx-auto max-w-4xl px-4 text-center">
        ...
        <p className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl animate-fade-in delay-400">
          データと宇宙飛行士。
          <br />
          ビジネスという宇宙を旅する、あなたの航海士。
        </p>
        <p className="mt-6 text-lg leading-8 text-gray-600 animate-fade-in delay-600">
          データは現代の未踏領域＝ビジネス宇宙。私たちはその広大な空間に挑む航海士（ナビゲーター）として、お客様の経営課題という“ブラックボックス”に挑み、知見とテクノロジーで突破口を拓きます。
        </p>
        <div className="mt-10">
          <Link
            href="/vision"
